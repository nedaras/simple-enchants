...
execute store result score @s telepathy.block_pos_2.x run scoreboard players get @s telepathy.block_pos_2.x
execute store result score @s telepathy.block_pos_2.y run scoreboard players get @s telepathy.block_pos_2.y
execute store result score @s telepathy.block_pos_2.z run scoreboard players get @s telepathy.block_pos_2.z
