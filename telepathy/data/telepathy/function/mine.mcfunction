...
execute store result storage telepathy:temp block_pos[0] run scoreboard players get @s telepathy.block_pos.x
execute store result storage telepathy:temp block_pos[1] run scoreboard players get @s telepathy.block_pos.y
execute store result storage telepathy:temp block_pos[2] run scoreboard players get @s telepathy.block_pos.z
